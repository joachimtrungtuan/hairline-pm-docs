---
description: Verify FR specifications against constitution, system PRD, client transcriptions, and dependencies. Trigger when user asks to review, verify, or validate any FR document.
globs:
alwaysApply: false
---
