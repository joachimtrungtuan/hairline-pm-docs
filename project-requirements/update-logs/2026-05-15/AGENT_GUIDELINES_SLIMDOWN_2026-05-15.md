...
- 2026-05-27: Updated `local-docs/README.md` so the high-level documentation overview explicitly includes `website-works/` and points task prompt references to `project-automation/task-prompt/`.
- 2026-05-27: Normalized heading levels and heading syntax in `local-docs/website-works/website-requirements/hairline-website-v2-design-brief.md` so numbered subsections are nested consistently and headings use plain Markdown instead of bold-wrapped heading text.
- 2026-05-27: Converted pseudo-numbered bullet items in `local-docs/website-works/website-requirements/hairline-website-v2-design-brief.md` into proper ordered lists and repaired the broken numbering sequence in the template-deliverables section for Markdown lint compliance.
