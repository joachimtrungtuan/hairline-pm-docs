...
Use these accounts to test patient-facing flows (registration, login, booking, profile, etc.).

| # | Email | Password | Notes |
|---|-------|----------|-------|
| P1 | joachimtrungtuan.work@gmail.com | 1234567890@Abc | Primary test patient |
